...
const Home = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable style = {styles.Child} onPress={() => {navigation.navigate('KakoSprijeciti')}}><Text style = {styles.DivTekst1}>Kako spriječiti požar?</Text></Pressable>
      ...
      <Pressable style = {styles.Child} onPress={() => {navigation.navigate('Info')}}><Text style = {styles.DivTekst1}>Informacije o aplikaciji</Text></Pressable>
    </View>
  );
};
